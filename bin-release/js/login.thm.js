window.skins=window.skins||{};
	...
	function LoginViewSkin() {
		_super.call(this);
		this.skinParts = ["imgWindSlow","imgWindFast","imgWindMiddle","groupWind","lbUserBook","lbPrivacyPolicy","gpRead","txt_account","groupAccount","txt_password","groupAccount0","btn_login","btn_register_back","group_login","lbUserBook0","lbPrivacyPolicy0","gpRead0","txt_register_tel","groupAccount1","txt_register_invitecode","groupAccount2","txt_register_pwd","groupAccount3","txt_register_repwd","groupAccount4","txt_register_verifycode","groupAccount5","btn_register","btn_login_back","group_register"];
	...
	_proto.group_login_i = function () {
		...
		t.verticalCenter = -51;
		t.visible = false;
		t.elementsContent = [this._Image2_i(),this.gpRead_i(),this.groupAccount_i(),this.groupAccount0_i(),this.btn_login_i(),this.btn_register_back_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto.groupAccount0_i = function () {
		var t = new eui.Group();
		this.groupAccount0 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.height = 91;
		t.scaleX = 1;
	...
	_proto.group_register_i = function () {
		...
		t.horizontalCenter = 8.5;
		t.verticalCenter = -9;
		t.elementsContent = [this._Image4_i(),this.gpRead0_i(),this.groupAccount1_i(),this.groupAccount2_i(),this.groupAccount3_i(),this.groupAccount4_i(),this.groupAccount5_i(),this.btn_register_i(),this.btn_login_back_i()];
		return t;
	};
	...
	_proto.gpRead0_i = function () {
		...
		t.elementsContent = [this._Image5_i(),this._Label5_i(),this.lbUserBook0_i(),this._Label6_i(),this.lbPrivacyPolicy0_i()];
		return t;
	};
	...
	_proto.groupAccount1_i = function () {
		...
		t.x = 71;
		t.y = 80;
		t.elementsContent = [this.txt_register_tel_i(),this._Label7_i()];
		return t;
	};
	...
	_proto.groupAccount2_i = function () {
		...
		t.x = 71;
		t.y = 148.85;
		t.elementsContent = [this.txt_register_invitecode_i(),this._Label8_i()];
		return t;
	};
	...
	_proto.groupAccount3_i = function () {
		...
		t.x = 71;
		t.y = 217.7;
		t.elementsContent = [this.txt_register_pwd_i(),this._Label9_i()];
		return t;
	};
	...
	_proto.groupAccount4_i = function () {
		...
		t.x = 71;
		t.y = 286.55;
		t.elementsContent = [this.txt_register_repwd_i(),this._Label10_i()];
		return t;
	};
	...
	_proto.groupAccount5_i = function () {
		...
		t.width = 432;
		t.x = 71;
		t.y = 356.40000000000003;
		t.elementsContent = [this.txt_register_verifycode_i(),this._Label11_i()];
		return t;
	};
